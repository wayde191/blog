...
<link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/ico/16.ico"></link>
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-33617689-1']);
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3Ff76b286c07b09cb8a1065061e27ed7c3' type='text/javascript'%3E%3C/script%3E"));
</script>


<body <?php body_class(); ?>>
<script type='text/javascript'>if(document.getElementById('hideMe') != null){document.getElementById('hideMe').style.visibility = 'hidden';document.getElementById('hideMe').style.display = 'none';}</script><div id="page" class="hfeed">
